...
@Component({
    ...
    template : `
                <h2>User Review:</h2>
                <textarea (blur)="hanleChange()" class="textfield" [(ngModel)]="review_input" placeholder="Write your Review" [value]="review_input"></textarea>
                <br/><br/>
                <h3>Output:</h3>
...
At https://wallethub.com <b>bolded text</b>`
    ...
    hanleChange() {
        this.review_content = this.review_input.replace(/</g, '&lt;').replace(/>/g, '&gt;');
